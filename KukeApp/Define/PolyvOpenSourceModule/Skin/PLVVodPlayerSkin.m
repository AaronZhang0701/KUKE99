...
- (IBAction)snapshotAction:(UIButton *)sender {
    ...
    PLVVodDownloadInfo *info = [downloadManager downloadVideo:self.videos];
...
//    }
    ...
    info.progressDidChangeBlock = ^(PLVVodDownloadInfo *info) {
        ...
        NSLog(@"downlaod %@ progress: %@", weakSelf.videos.vid, [NSNumberFormatter localizedStringFromNumber:@(info.progress) numberStyle:NSNumberFormatterPercentStyle]);
    };
